  ...
  const checkWords = (pureWordStrings) => {
    ...
    getWord(subWord)
      .then(({ data }) => {
        ...
        let notWord = subWord.word.filter(val => !checkedWords.includes(val)) // array of non words
        let yesWord = subWord.word.filter(val => checkedWords.includes(val)) // array of correct words
  ...
  return(
    <>
      <div className="container">
        <h3 className="center">Speed Scrabble (TEST PAGE)</h3>
        ...
        <div className="row white" style={{width: "100%", padding:"1vw 0px 1vw 0px",margin:"0px"}}>
          ...
          {/* MY HAND + TILESWAP (TESTPAGE)*/}
          <div className="col s12 m12 l5 green" style={{padding:"0px 4px 0px 4px", marginBottom:"10px"}}>
            <div className="col s4 m4 l4 center" style={{padding:"0px 0px 0px 0px"}}>
              <h5>TILE SWAP</h5>
              <div id="swapTile" className="valign-wrapper"
                onDrop={swapOneTile}
                onDragOver={allowDrop}
              ><h5 className="white-text center">{swapCount + " left"}</h5>
              </div>
            </div>
          ...
          {/* GRID BOARD (TESTPAGE) */}
          <div className="col s12 m12 l6 center blue">
            {grid.map((row, rowNum)=>(
              <div id="gridRow" 
                // className="center"
              >
          ...
          <div className="col s12 m12 l1 center red">
            <br></br>
        ...
        <div className="row purple center">
          <div className="col s12 m6 l3 red">COL ONE</div>
          <div className="col s12 m6 l3 orange"> COL TWO</div>
          <div className="col s12 m6 l3 yellow">COL THREE</div>
          <div className="col s12 m6 l3 green">COL FOUR</div>
        </div>
    </>
  )
}
